...
type DecomposeToPrimeNumbersRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DecomposeToPrimeNumbersRequest) Reset() {
	*x = DecomposeToPrimeNumbersRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *DecomposeToPrimeNumbersRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DecomposeToPrimeNumbersRequest) ProtoMessage() {}

func (x *DecomposeToPrimeNumbersRequest) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_calculatorpb_calculator_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DecomposeToPrimeNumbersRequest.ProtoReflect.Descriptor instead.
func (*DecomposeToPrimeNumbersRequest) Descriptor() ([]byte, []int) {
	return file_calculator_calculatorpb_calculator_proto_rawDescGZIP(), []int{2}
}

func (x *DecomposeToPrimeNumbersRequest) GetNumber() int32 {
	if x != nil {
		return x.Number
	}
	return 0
...
type DecomposeToPrimeNumbersResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DecomposeToPrimeNumbersResponse) Reset() {
	*x = DecomposeToPrimeNumbersResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *DecomposeToPrimeNumbersResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DecomposeToPrimeNumbersResponse) ProtoMessage() {}

func (x *DecomposeToPrimeNumbersResponse) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_calculatorpb_calculator_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DecomposeToPrimeNumbersResponse.ProtoReflect.Descriptor instead.
func (*DecomposeToPrimeNumbersResponse) Descriptor() ([]byte, []int) {
	return file_calculator_calculatorpb_calculator_proto_rawDescGZIP(), []int{3}
}

func (x *DecomposeToPrimeNumbersResponse) GetPrimeNumber() int32 {
	if x != nil {
...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x09, 0x73, 0x75, 0x6d, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x38, 0x0a, 0x1e, 0x44, 0x65,
	0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x65, 0x54, 0x6f, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x4e, 0x75,
	...
	0x6d, 0x62, 0x65, 0x72, 0x22, 0x44, 0x0a, 0x1f, 0x44, 0x65, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73,
	0x65, 0x54, 0x6f, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x70, 0x72, 0x69, 0x6d, 0x65,
	0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x70,
	0x72, 0x69, 0x6d, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x32, 0xc5, 0x01, 0x0a, 0x11, 0x43,
	...
	0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x65, 0x54, 0x6f, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x4e, 0x75,
	0x6d, 0x62, 0x65, 0x72, 0x73, 0x12, 0x2a, 0x2e, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74,
	0x6f, 0x72, 0x2e, 0x44, 0x65, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x65, 0x54, 0x6f, 0x50, 0x72,
	0x69, 0x6d, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x2b, 0x2e, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x44,
	0x65, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x65, 0x54, 0x6f, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x4e,
...
var file_calculator_calculatorpb_calculator_proto_goTypes = []interface{}{
	...
	(*DecomposeToPrimeNumbersRequest)(nil),  // 2: calculator.DecomposeToPrimeNumbersRequest
	(*DecomposeToPrimeNumbersResponse)(nil), // 3: calculator.DecomposeToPrimeNumbersResponse
}
var file_calculator_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	2, // 1: calculator.CalculatorService.DecomposeToPrimeNumbers:input_type -> calculator.DecomposeToPrimeNumbersRequest
	1, // 2: calculator.CalculatorService.Sum:output_type -> calculator.SumResponse
	3, // 3: calculator.CalculatorService.DecomposeToPrimeNumbers:output_type -> calculator.DecomposeToPrimeNumbersResponse
...
func file_calculator_calculatorpb_calculator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_calculator_calculatorpb_calculator_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DecomposeToPrimeNumbersRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_calculator_calculatorpb_calculator_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DecomposeToPrimeNumbersResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
